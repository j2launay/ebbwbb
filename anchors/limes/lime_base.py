...
class LimeBase(object):
    ...
    def explain_instance_with_data(self,
        ...
        weights = distances#self.kernel_fn(distances)
        ...
        """used_features = self.feature_selection(neighborhood_data,
                                               ...
                                               feature_selection)
        """
        # TODO est-ce que le vecteur de l'instance cible est la taille totale du vocab ou seulement celui du vecteur de la phrase ? 
        try:
            used_features = [*range(neighborhood_data[0].shape[1])]
        except IndexError:
            used_features = self.feature_selection(neighborhood_data,
                                               labels_column,
                                               weights,
        ...
        return (easy_model.intercept_,
                ...
                prediction_score, 
                local_pred, easy_model, used_features)